...
#define STRING_CONFIG_H_AUTHOR "Attila H." // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HeAt 3D Printer"
#define STRING_DISTRIBUTION_DATE __DATE__
#define SHORT_BUILD_VERSION "bugfix-2.1.x HeAt"
...
#define HOTEND_OFFSET_X { 0.0, 18.5 } // (mm) relative X-offset for each nozzle
